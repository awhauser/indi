...
\vspace{0.3cm} & \vspace{0.3cm} \\
 ...
 & \noindent\large{Ralf  Meyer,\textit{$^{a}$} Berhard Thaler,\textit{$^{a}$} Stefan Cesnic,\textit{$^{a}$} Sascha Ranftl,\textit{$^{a}$} Johann V. Pototschnig,$^{\ast}$\textit{$^{a}$}  Wolfgang E. Ernst,\textit{$^{a}$} Markus Koch,\textit{$^{a}$} and Andreas W. Hauser$^{\ast}$\textit{$^{a}$}} \\
